    ...
    try {
      ...
      if (body.custom) {
        ...
        const newFact: IFactura = {
          ...
          total_iva:
            pvData[0].cond_iva === 1 ? Math.round(ivaTotal * 100) / 100 : 0,
          total_neto:
            pvData[0].cond_iva === 1
              ? Math.round(netoTotal * 100) / 100
              : Math.round(body.total_fact * 100) / 100,
          total_compra: 0,
        ...
        if (body.fiscal) {
          dataFiscal = {
            ...
            DocNro:
              Number(cliente.cliente_tdoc) === 99
                ? 0
                : cliente.cliente_ndoc || 0,
